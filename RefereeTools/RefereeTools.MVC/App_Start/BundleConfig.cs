    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/wijmo").Include(
                        "~/Scripts/jquery.wijmo-complete.all.2.3.5.min.js",
                        "~/Scripts/jquery.wijmo-open.all.2.3.5.min.js",
            ...
            bundles.Add(new StyleBundle("~/Content/jquery/css").Include(
                        ...
                        "~/Areas/Officiating/Views/Shared/jquery-wijmo-override.css"));

            bundles.Add(new StyleBundle("~/content/app/css").Include(
                        "~/Content/RefereeTools.css",
                        "~/Content/Site.css"));

            bundles.Add(new StyleBundle("~/content/bootstrap").Include(
                        "~/Content/bootstrap.css",
                        "~/Areas/Officiating/Views/Shared/bootstrap-override.css",
